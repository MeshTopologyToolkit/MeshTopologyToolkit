...
public class ChangeSpaceOperatorTests
{
    private readonly ITestOutputHelper _testOutput;

    public ChangeSpaceOperatorTests(ITestOutputHelper testOutput)
    {
    ...
    public void TansformPosition()
    {
        ...
        var spaceTransform = new SpaceTransform(Matrix4x4.CreateRotationY(MathF.PI / 2.0f) * Matrix4x4.CreateScale(-1, 1, 1), new Vector3(1, 1, 1));
        var changeSpace = new ChangeSpaceOperator(spaceTransform);
        ...
        changeSpace = new ChangeSpaceOperator(spaceTransform);
